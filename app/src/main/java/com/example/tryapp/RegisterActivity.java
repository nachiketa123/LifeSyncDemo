...
//    }
    ...
    private void getDataAndSaveItToDB() {
        String name,email,mobile,returnId=null;
        ...
        User user = new User(type,returnId);
        returnId = new RealTimeDBHandler(RegisterActivity.this).onCreateReference(user);
        RegisterActivity.USERID = returnId;
    }
